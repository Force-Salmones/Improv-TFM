...
bannedPlayers={}
players={}
hiddenCommands={"maplist","addmap","removemap","map","score","mod","gametype","ban","unban","profile"}
maplist={}
...
function eventPlayerDataLoaded(name,data)
 ...
 --changes
 --fixed hard nailzones not larger
 --balanced type + amount combo
 --fixed bug on gamestart
 --profile command is now hidden